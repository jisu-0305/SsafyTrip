...
INSERT INTO members (name, gender, email, password, birth_date, address, role)
VALUES
    ('홍길동', 'M', 'hong', '123', '1990-05-10', '서울특별시 강남구 역삼동 123-45', 'ROLE_USER'),
    ('김민지', 'F', 'minji', '456', '1985-08-15', '서울특별시 마포구 합정동 678-90', 'ROLE_ADMIN');
